            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-5 gap-3">
                {[
                  ...
                  <button
                    ...
                    onClick={() =>
                      setEditedProject((prev) =>
                        prev ? { ...prev, headerColor: color.name } : null
                      )
                    }
                    className={`relative h-16 w-full rounded-xl ${color.bg} border-2 transition-all duration-200 hover:scale-105 ${
                  ...
                  >
                    <div
                      className={`absolute bottom-2 right-2 h-3 w-3 rounded-full ${color.accent}`}
                    />
                    {editedProject.headerColor === color.name && (
