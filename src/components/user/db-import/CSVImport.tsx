...
import { Upload, Database, Check, X, AlertCircle, ArrowRight, FileSpreadsheet } from 'lucide-react';
...
export default function CSVImport() {
  ...
  const steps = [
    { id: 'first-step', label: 'Upload File', component: <FirstStep onFileUpload={() => setFileUploaded(true)} /> },
    ...
    <Card className="border border-gray-200 shadow-sm bg-white w-full">
      <CardHeader className="bg-gray-50 border-b border-gray-200">
        ...
        <CardDescription className="text-gray-600">
          Import your database using a CSV file
        </CardDescription>
      </CardHeader>
      ...
      <CardFooter className="flex justify-between pt-4 border-t border-gray-200 bg-white">
        ...
        <Button
          ...
          disabled={currentStep === 0 && !fileUploaded}
