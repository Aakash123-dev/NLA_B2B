                                          ...
                                          <div className="h-64">
                                            <ResponsiveContainer width="100%" height="100%">
                                              <RechartsLineChart
                                                data={[
                                                  { 
                                                    price: product.latestPrice * 0.9, 
                                                    units: product.totalUnits * 1.1, 
                                                    revenue: (product.latestPrice * 0.9) * (product.totalUnits * 1.1) 
                                                  },
                                                  { 
                                                    price: product.latestPrice, 
                                                    units: product.totalUnits, 
                                                    revenue: product.totalDollars 
                                                  },
                                                  { 
                                                    price: parseFloat(product.newPrice) || product.latestPrice, 
                                                    units: Math.round(product.totalUnits * 0.92), 
                                                    revenue: (parseFloat(product.newPrice) || product.latestPrice) * Math.round(product.totalUnits * 0.92) 
                                                  },
                                                  { 
                                                    price: product.latestPrice * 1.1, 
                                                    units: product.totalUnits * 0.85, 
                                                    revenue: (product.latestPrice * 1.1) * (product.totalUnits * 0.85) 
                                                  }
                                                ]}
                                              >
                                                <CartesianGrid strokeDasharray="3 3" className="opacity-30" />
